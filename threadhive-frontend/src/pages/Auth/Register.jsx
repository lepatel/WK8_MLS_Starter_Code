...
function Register() {
  ...
  const loading = useSelector((state) => state.auth.registration.status === 'loading');
  const error = useSelector((state) => state.auth.registration.error);
  const registrationSuccess = useSelector((state) => state.auth.registration.status === 'succeeded');
